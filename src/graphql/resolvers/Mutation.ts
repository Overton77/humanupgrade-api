...
import {
  createProductWithOptionalRelations,
  updateProductWithOptionalRelations,
...
} from "../inputs/BiomarkerInputs.js";
import { Biomarker } from "../types/BiomarkerModel.js";
import {
  createLabTestWithOptionalRelations,
  updateLabTestWithOptionalRelations,
} from "../../services/LabTest/labTestService.js";
import {
  createPanelDefinitionWithOptionalRelations,
  updatePanelDefinitionWithOptionalRelations,
} from "../../services/PanelDefinition/panelDefinitionService.js";
import {
  createBiomarker,
  updateBiomarker,
} from "../../services/Biomarker/biomarkerService.js";
...
export const Mutation = {
  ...
  updateProduct: async (
    ...
    const product = await updateProductWithOptionalRelations(args.input);
  ...
  createPanelDefinition: async (
    ...
    const panelDefinition = await createPanelDefinitionWithOptionalRelations(
      args.input,
    );
  ...
  updatePanelDefinition: async (
    ...
    const panelDefinition = await updatePanelDefinitionWithOptionalRelations(
      args.input,
    );
    return panelDefinition;
  },
